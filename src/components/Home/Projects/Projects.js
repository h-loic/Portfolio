                ...
                <div className='text-center margin-header h1 project-part-title col-12'>
                    ...
                    <div className='w-100 row m-0'>
                        ...
                        <div className={`project-box block col-10 col-md-8 ${reveal}4`}>
                            ...
                            <span className={`more-info ${revealInner}4 ${invisible}`} onClick={() => navigate("/greenIT",{state:{dictionary:props.dictionary}})}>{props.dictionary.moreInfo}</span>
                        </div>
                        <div className='col-1 col-md-2'/>
                        ...
                        <div className={`project-box block col-10 col-md-8 ${reveal}5`}>
                            ...
                            <span className={`more-info ${revealInner}5 ${invisible}`} onClick={() => navigate("/asd",{state:{dictionary:props.dictionary}})}>{props.dictionary.moreInfo}</span>
                        </div>
                        <div className='col-1 col-md-2'/>
