                    ...
                    <div className='timeline-item'>
                        ...
                        <div className='timeline-content justify-content-center'>
                            <div className='text-content'>
                                ...
                                <p className='light-grey'>Baccalauréat S SI - Mention Bien</p>
                            </div>
                        </div>
                    </div>
                    <div className='timeline-item'>
                        ...
                        <div className='timeline-content justify-content-center'>
                            <div className='text-content'>
                                ...
                                <p className='light-grey'>DUT Informatique - 120 ECTS</p>
                            </div>
                        </div>
                    </div>
                    <div className='timeline-item'>
                        ...
                        <div className='timeline-content justify-content-center'>
                            <div className='text-content'>
                                ...
                                <p className='light-grey'>Engineering cours - 310 ECTS</p>
                            </div>
                        </div>
                    </div>
                    <div className='timeline-item'>
                        ...
                        <div className='timeline-content justify-content-center'>
                            <div className='text-content'>
                                <p className='light-grey'>I am looking for an internship that could be followed by a hiring</p>
                            </div>
                        </div>
                    </div>
                    </Slider>
