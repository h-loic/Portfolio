                ...
                <div className='content-about-part container'>
                    <Slider {...settings} >
                        <div className='timeline-item'>
                            ...
                            <div className='timeline-content justify-content-center'>
                                <div className='text-content'>
                                    <p className='dark-gray'>Lycée Jean-Jacques Henner</p>
                                    <p className='dark-gray'>Altkirch (FR)</p>
                        ...
                        <div className='timeline-item'>
                            ...
                            <div className='timeline-content justify-content-center'>
                                <div className='text-content'>
                                    <p className='dark-gray'>IUT Belfort-Montbéliard - Cegep de Matane</p>
                                    <p className='dark-gray'>Belfort (FR) / Matane (QC)</p>
                        ...
                        <div className='timeline-item'>
                            ...
                            <div className='timeline-content justify-content-center'>
                                <div className='text-content'>
                                    <p className='dark-gray'>Université de Technologie de Belfort-Montnéliard (UTBM)</p>
                                    <p className='dark-gray'>Belfort (FR)</p>
